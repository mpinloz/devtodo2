...
var reparentFlag = flag.Bool("mv", false, "Reparent task A below task B. If no B informed, root is chosen")
...
var helpManFlag = flag.Bool("help-man", false, "Generate the man page in file todo2.1")
